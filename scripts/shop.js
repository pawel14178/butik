$(function(){
    ...
    $('#products_menu').on('click', 'button', function(e){
        ...
        function loadProduct(){
            $.ajax({
                type: "GET",
                url: "scripts/Dates/"+ loc +".json",
                timeout: 2000,
                beforeSend: function(){
                    $('.wrapper_section').html('<div class="loader"> Wczytywanie opinii ... </div>')
                },
                complete: function(){
                    $(".loader").remove()
                },
                success: function(data){
                    ...
                    msg[x]="<div class=\"wrapper__section-picture\">" +
                                ...
                                "<div class=\"wrapper__section-info\">" +
                                    "<p class=\"description\">"+times[loc][x].description + " "+loc+" " + times[loc][x].name + " <b class='description_price'> "+times[loc][x].price+"</b> zł </p>" +
